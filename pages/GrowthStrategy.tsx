...
import {
  ...
  BookOpen, Search, X, CheckCircle2, Loader2,
  User, ArrowRight
} from 'lucide-react';
import {
            ...
            >
              ...
              <form onSubmit={handleCreatePath} className="p-10 space-y-8">
                ...
                <button
                  ...
                  className={`w-full py-5 rounded-2xl font-black uppercase tracking-widest text-[11px] shadow-2xl flex items-center justify-center gap-3 transition-all ${success ? 'bg-emerald-500 text-white' : 'bg-indigo-600 text-white hover:bg-indigo-700'
                    }`}
                >
