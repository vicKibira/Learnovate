            ...
            >
              <div className={viewMode === 'grid' ? 'mb-0' : 'flex items-center gap-8 flex-1'}>
                <div className="absolute top-0 right-0 p-6 flex flex-col items-end">
                  <span className={`px-4 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest ${c.status === 'Offer' ? 'bg-emerald-50 text-emerald-600 dark:bg-emerald-500/10' :
          ...
          <div className="fixed inset-0 z-[200] flex items-center justify-center p-6 md:p-12">
            ...
            >
              <div className="p-10 border-b border-slate-100 dark:border-white/5 flex items-center justify-between bg-gradient-to-r from-indigo-50/50 to-white dark:from-slate-800/50 dark:to-slate-900">
                <div className="flex items-center gap-6">
                  <div className={`w-16 h-16 rounded-2xl flex items-center justify-center text-white shadow-xl ${activeModalAction === 'email' ? 'bg-indigo-600' :
